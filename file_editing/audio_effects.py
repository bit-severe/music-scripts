...
EFFECTS = {
    ...
    "bitcrusher": "acrusher=bits=4:mode=log:aa=0",
    "reverse": "areverse",
...
def process_directory(audio_directory, ir_directory, effect):
    """
...
def parse_arguments():
    ...
    parser.add_argument("--irdir", type=str, required=False, default="", help="Path to impulse response files.")
    parser.add_argument("--effect", type=str, required=False, default="all", help="Specify the effect to be applied. Default is all", choices=["reverb","echo","highpass","lowpass","speed_up","slow_down","pitch_up","pitch_down","distortion","flanger","phaser","chorus","tremolo","bass_boost","treble_boost","compressor","limiter","wahwah","stereo_widen","bitcrusher","reverse","crystalizer"])
    return parser.parse_args()            

if __name__ == "__main__":
    args = parse_arguments()
    process_directory(args.audiodir, args.irdir, args.effect)
